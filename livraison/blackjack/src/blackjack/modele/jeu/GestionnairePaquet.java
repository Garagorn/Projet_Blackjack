...
public class GestionnairePaquet {
    ...
    public void distribuerCarteJoueurs(Joueur joueur) {
        ...
        // Vérifier que le paquet n'est pas vide après remélange
        if (paquet.estVide()) {
            throw new IllegalStateException("Impossible de distribuer : le paquet est vide même après remélange.");
        }
    ...
    public void distribuerCarteCroupier(Croupier croupier) {
        ...
        //Verifier si le paquet est vide
        if (paquet.estVide()) {
            throw new IllegalStateException("Impossible de distribuer : le paquet est vide même après remélange.");
        }
        // Prendre la première carte de la pioche
