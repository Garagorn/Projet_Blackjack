...
\begin{titlepage}
    ...
    %THOMAS Matthieu : NUM_ETU\\[0.5cm]
    %SIAGHI Massinissa : 22312276\\[0.5cm]
    %TELLIER Basile : NUM_ETU\\[1.0cm]



    {\Large 4 novemvre 2025}
...
Ce rapport a pour objectif de retracer de manière claire et progressive le développement du projet \textbf{Blackjack}. Il est structuré en six sections, chacune correspondant à une phase essentielle du projet :
...
\foreach \x/\label/\month in {
    ...
    4.4/Architecture MVC/Octobre,
    6.6/Implémentation du Modèle/Octobre,
    8.8/Implémentation du Contrôleur/Octobre,
    11/Interface graphique/Octobre,
    15.4/Tests \& Rapport/Novembre
} {
...
\subsection{Synthèse : une architecture MV-C }
