...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/Observer.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/strategie.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/adaptateur.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/command_pattern.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/controleur.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/Vueblackjack.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/modeleBJ.png}
...
\begin{center}
    \includegraphics[width=0.90\textwidth]{images/images_uml/mvc.png}
...
\begin{center}
    \includegraphics[width=1.05\textwidth]{images/images_uml/mvc_fonctionnement_example.png}
